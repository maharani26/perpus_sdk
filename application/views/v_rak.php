	...
	<table class="table table-hover table-stripped"> 
		...
		foreach($rak as $mr): $no++;?>
			<tr>
				...
				<a href="#ubah" data-toggle="modal" onclick="edit(<?=$mr->kode_rak?>)"  class="btn btn-success">Edit</a><?php 
				} else { 		
					// echo "Kasir"; 
					}?></td>
				<td><?php if($this->session->userdata('level')=="admin"){?>
				<a href="<?=base_url('index.php/rak/hapus/'.$mr->kode_rak)?>" class="btn btn-danger" onclick="return confirm('Apakah Anda Yakin Ingin Menghapus?')" >Hapus</a><?php 
				} else { 
					// echo "Kasir";
					 }?></td>
			</tr>
